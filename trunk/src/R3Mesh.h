...
struct R3MeshEdge {
  ...
  R3MeshEdge(R3MeshVertex *origin, R3MeshEdge *next,
	     R3MeshEdge *inverse, R3MeshFace *face);
...
struct R3MeshVertex {
  ...
  vector<R3MeshEdge *> Edges(void) const;
  vector<R3MeshFace *> Faces(void) const;
  // Update functions
...
struct R3MeshFace {
  ...
  R3MeshFace(R3MeshEdge *edge, const R3Plane& plane);
...
struct R3Mesh {
  ...
  R3MeshEdge *CreateEdge(R3MeshVertex *origin, R3MeshVertex *terminus, R3MeshFace *face);
  void DeleteVertex(R3MeshVertex *vertex);
  void DeleteFace(R3MeshFace *face);
  void DeleteEdge(R3MeshEdge *edge);
  ...
  // Helper
  void Sort_CCW(vector<R3MeshVertex *>& v, const R3Vector& normal);
  // Data
  vector<R3MeshVertex *> vertices;
  ...
  // This is used during the buildup of the class
  map<int, map<int, R3MeshEdge *> > edge_map;
  map<int, map<int, R3MeshVertex *> > vertex_map;
  // This is used to ensure we initialize the randomizer
  // only once
  bool randomed;
};
